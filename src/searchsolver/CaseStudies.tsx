        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-6">
          <div className="max-w-xl text-left">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-white mb-4 uppercase tracking-tighter">
              REAL IMPACT. <span className="bg-gradient-to-r from-brand-gold to-brand-gold-soft bg-clip-text text-transparent">REAL OUTCOMES.</span>
            </h2>
        ...
        <AnimatePresence mode="wait">
          ...
          >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <span className="w-2.5 h-2.5 bg-brand-gold rounded-none"></span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-brand-gray border border-white/5 p-4 rounded-none">
                    <p className="text-[10px] font-mono text-brand-gold uppercase font-bold">Strategic Lift</p>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-brand-gray border border-white/5 p-3.5 rounded-none">
                      ...
                      <p className="text-sm font-bold text-brand-gold mt-1 font-mono">{selectedCase.revenueGenerated}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 bg-[#0D0D0D] p-5 border border-white/[0.03]">
                <div className="flex items-center justify-between mb-6">
                  <div className="text-left">
                    ...
                    <span className="text-[11px] font-mono text-[#F5B82E] uppercase tracking-wider block mt-0.5">Search Acquisition Curve</span>
                  </div>
                  {/* Miniature pulse indicator */}
                  <div className="flex items-center gap-1.5 bg-[#F5B82E]/10 border border-[#F5B82E]/30 px-2 py-0.5 text-[8px] font-mono uppercase text-[#F5B82E]">
                    <span className="w-1 h-1 bg-[#F5B82E] rounded-none animate-ping" />
                ...
                <div className="relative py-4 px-1">
                  ...
                  <motion.div 
                    className="absolute left-6 h-[2px] bg-gradient-to-r from-[#F5B82E] to-[#FFD466] top-1/2 -translate-y-1/2 origin-left z-0"
                    initial={{ width: "0%" }}
                        ...
                        <div key={idx} className="flex flex-col items-center relative group">
                          ...
                          <div className="absolute bottom-full mb-3 flex flex-col items-center transition-all duration-300 transform group-hover:-translate-y-1 select-none">
                            <span className={`font-mono text-[9px] px-1.5 py-0.5 border font-bold ${
                              isLast 
                                ? 'bg-[#F5B82E] text-black border-[#F5B82E] shadow-[0_0_10px_rgba(245,184,46,0.3)]' 
                            ...
                            <div className={`w-1.5 h-1.5 rotate-45 border-r border-b -mt-1 ${
                              isLast ? 'bg-[#F5B82E] border-[#F5B82E]' : 'bg-[#18181B] border-r-white/5 border-b-white/5'
                            }`} />
                          </div>
                          ...
                          <motion.div
                            ...
                            className={`w-8 h-8 rounded-full flex items-center justify-center font-mono text-[10px] font-bold border transition-all duration-300 cursor-help ${
                              isLast
                                ? 'bg-[#F5B82E] text-black border-[#F5B82E] ring-4 ring-[#F5B82E]/20 shadow-[0_0_15px_rgba(245,184,46,0.4)]'
                                : 'bg-brand-dark/95 text-zinc-400 border-zinc-700 hover:border-[#F5B82E] hover:text-white'
                            }`}
                          >
                            {idx + 1}
                          </motion.div>
                          ...
                          <span className={`text-[8px] font-mono uppercase tracking-wider mt-3 font-semibold ${
                            isLast ? 'text-[#F5B82E]' : 'text-zinc-500'
                          }`}>
                ...
                <div className="mt-5 pt-3.5 border-t border-white/[0.04] flex items-center justify-between text-[9px] font-mono text-zinc-500">
                  ...
                  <span>PEAK TARGET: <strong className="text-[#F5B82E]">{(selectedCase.timeline[selectedCase.timeline.length - 1].value).toLocaleString()} views</strong></span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 bg-[#141414] border border-white/5 p-6 sm:p-8 rounded-none flex flex-col justify-between">
              <div className="space-y-6">
                <div>
                  <span className="text-[10px] font-mono text-brand-gold uppercase tracking-widest block mb-1 font-bold">PROJECT SUMMARY</span>
                  ...
                  {selectedCase.imageUrl && (
                    <div className="relative group overflow-hidden border border-white/5 aspect-[16/10] sm:aspect-[16/9] md:aspect-[21/9] bg-[#0A0A0A] mb-4">
                      ...
                      <div className="absolute bottom-4 left-4 font-mono text-[9px] text-zinc-300 uppercase tracking-widest flex items-center gap-1.5 z-10 bg-black/50 px-2 py-1 border border-white/5">
                        <span className="w-1.5 h-1.5 bg-[#F5B82E] rounded-none animate-pulse" />
              ...
              <div className="mt-8 pt-6 border-t border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 border border-brand-gold text-brand-gold bg-transparent hover:bg-brand-gold hover:text-black px-5 py-3 uppercase text-xs font-bold tracking-widest transition-all rounded-none font-display cursor-pointer"
